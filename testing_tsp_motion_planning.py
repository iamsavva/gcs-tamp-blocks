...
visitations = np.array([1, 1, 1]) # will become mute
...
MotionPlanning(prog, vertices, edges, bounding_box, start_block_pos, target_block_pos, convex_sets, moving_block_index, convex_relaxation)
