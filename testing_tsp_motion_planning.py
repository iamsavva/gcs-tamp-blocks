...
from gcs_for_blocks.axis_aligned_set_tesselation_2d import Box, AlignedSet, plot_list_of_aligned_sets
import numpy as np
...
mp.build_the_program(convex_relaxation)

plot_list_of_aligned_sets(mp.convex_sets, bounding_box, visitations)