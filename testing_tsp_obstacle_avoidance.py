...
def process_and_solve(bounding_box, start, target, block_width, convex_relaxation=False, fast=True):
    ##################
    # tolerances
...
start = [(0.5, 4.5), (0.5, 0.5), (0.5, 2.5), (2.5, 2.5), (2.5, 0.5), (0.5, 5.5), (2.5, 4.5)]
target = [(0.5, 5.5), (6.5, 0.5), (4.5, 0.5), (4.5, 2.5), (4.5, 4.5), (6.5, 4.5), (6.5, 2.5)]
fast = True
